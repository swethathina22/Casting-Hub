...
def insertusersdetails():
    ...
    d = """
        INSERT INTO usersdetails(uid, name, mobile, email, role, profilepic, videoname,password)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
    """
    values = (
        eid,
...
def sendemail(r,startdate,enddate,address):
    ...
    msg = MIMEMultipart()
    msg['From'] = 'classvebbox@gmail.com'
    msg['To'] = r
    msg['Subject'] = subject
    ...
    with smtplib.SMTP('smtp.gmail.com', 587) as server:
        server.ehlo()
        server.starttls()
        server.login('classvebbox@gmail.com', 'wfvmiraatzkeqncw')
        server.sendmail('classvebbox@gmail.com', r, msg.as_string())
